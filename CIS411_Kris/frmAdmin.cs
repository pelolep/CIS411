            ...
            try
            {
                ...
                if (rd.HasRows)
                {
                    ...
                    while (rd.Read())
                    {
                        ...
                        listBoxLoggedIn.Items.Add(jdate.ToString("MM/dd/yyyy") + "\t" + rd[2] + "\t\t" + rd[0].ToString().PadRight(10-rd[0].ToString().Length) + "\t" + rd[13] + "\t\t" + rd[14]);
                    }
                }
            }
            catch
            ...
            try
            {
                ...
                if (rd.HasRows)
                {
                    while (rd.Read())
                    {
                        ...
                        DateTime jdate = DateTime.Parse(rd[1].ToString());
                        listBoxLoggedIn.Items.Add(jdate.ToString("MM/dd/yyyy") + "\t" + rd[3] + "\t\t" + rd[0].ToString().PadRight(10 - rd[0].ToString().Length) + "\t" + rd[4] + "\t\t" + rd[5]);
                    }
                }
            }
            catch
