        ...
        private void displayBtn_Click(object sender, EventArgs e)
        {
            ...
            switch (comboCountCategory.SelectedItem.ToString())
            {
                case "Method":
                    ...
                    if (comboFilter.SelectedItem == "Do not filter")
                    {
                ...
                case "Student":
                    ...
                    else if (comboFilter.SelectedItem == "Visits")
                    {
                        column = "CLARION_ID,count(distinct time_difference)";
                        table = "VISIT";
                        condition = "where time_difference is not null group by clarion_id";
                ...
                case "Tutor":
                   ...
                   newtime = new TimeSpan();
                    ...
                    else if (comboFilter.SelectedItem == "Days Worked")
                    {
                        column = "tutor_ID,count(distinct time_difference)";
                        table = "tutor_hour";
                        condition = "where time_difference is not null group by tutor_id";
                ...
                case "Course":
                    ...
                    else if (comboFilter.SelectedItem == "Total Courses")
                    {
                        int count = 0;
                        rd = conn.GetReader(column, table, condition);
                        while (rd.Read())
...
MessageBox.Show("sfgfdsgfg");
        ...
        private void comboCountCategory_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            comboFilter.Items.Add("Do not filter");
